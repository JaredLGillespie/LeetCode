...
429 | [N-ary Tree Level Order Traversal](https://leetcode.com/problems/n-ary-tree-level-order-traversal/) | Easy | [Python](./Python/n-ary-tree-level-order-traversal.py)
...
500 | [Keyboard Row](https://leetcode.com/problems/keyboard-row/) | Easy | [Python](./Python/keyboard-row.py)
...
653 | [Two Sum IV - Input is a BST](https://leetcode.com/problems/two-sum-iv-input-is-a-bst/) | Easy | [Python](./Python/two-sum-iv-input-is-a-bst.py)
...
883 | [Projection Area of 3D Shapes](https://leetcode.com/problems/projection-area-of-3d-shapes/) | Easy | [Python](./Python/projection-area-of-3d-shapes.py)
